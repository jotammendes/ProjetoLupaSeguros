...
@section('conteudo')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <a class="btn btn-primary mb-3" href="{{ route('cliente.index') }}">Voltar</a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detalhes de Cliente</h5>
    ...
    <div id="modalRestaurar" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Restaurar cliente</h5>
                    <button type="button" class="close" data-dismiss="modal">
                        <span>&times;</span>
                    </button>
                </div>
                <div align="center" class="modal-body">Tem certeza que deseja restaurar este Cliente?</div>
                <div class="modal-footer">
